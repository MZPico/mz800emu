...
#include <stddef.h>     /* NULL - pod glibc se netahne tranzitivne pres stdint.h */
...
typedef struct {
    ...
    uint8_t flags_affected;      /**< Bitova maska ovlivnenych flagu (Z80_FLAG_*). */
    uint16_t regs_read;          /**< Bitova maska ctenych registru (z80_dasm_reg_mask_t). */
    uint16_t regs_written;       /**< Bitova maska zapisovanych registru. */
    uint8_t flow_type;           /**< Typ toku rizeni (z80_flow_type_t). */
    uint8_t inst_class;          /**< Trida instrukce (z80_inst_class_t). */
} z80_dasm_opc_t;
...
/** @{ */
#define RA   Z80_DASM_REG_A
#define RF   Z80_DASM_REG_F
#define RB   Z80_DASM_REG_B
#define RC   Z80_DASM_REG_C
#define RD   Z80_DASM_REG_D
#define RE   Z80_DASM_REG_E
#define RH   Z80_DASM_REG_H
#define RL_  Z80_DASM_REG_L      /* RL_ kvuli kolizi s makrem RL v ai2-z80 */
#define RAF  Z80_DASM_REG_AF
#define RBC  Z80_DASM_REG_BC
#define RDE  Z80_DASM_REG_DE
#define RHL  Z80_DASM_REG_HL
#define RSP  Z80_DASM_REG_SP
#define RIXH Z80_DASM_REG_IXH
#define RIXL Z80_DASM_REG_IXL
#define RIYH Z80_DASM_REG_IYH
#define RIYL Z80_DASM_REG_IYL
#define RIX  Z80_DASM_REG_IX
#define RIY  Z80_DASM_REG_IY
#define RI   Z80_DASM_REG_I
#define RR_  Z80_DASM_REG_R
#define RWZ  Z80_DASM_REG_WZ
/** @} */
