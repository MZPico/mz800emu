...
/** @copydoc mzglyphs_get_codepoint */
uint32_t mzglyphs_get_codepoint ( uint8_t video_code, en_MZGLYPHS_CHARSET charset ) {
    return 0xE100 + ( (uint32_t) charset * 0x100 ) + video_code;
}


/** @copydoc mzglyphs_to_utf8_buf */
void mzglyphs_to_utf8_buf ( uint8_t video_code, en_MZGLYPHS_CHARSET charset, char *buf ) {
    uint32_t codepoint = mzglyphs_get_codepoint ( video_code, charset );
